...
export const AMAZON_ECO_REGISTRY: EcoRegistryEntry[] = [
  {
    ...
    ecoGstin: "01AAICA3918J1C7",
    legalName: "Amazon Seller Services Pvt Ltd",
    status: "VERIFIED",
    source: "Amazon TCS Master",
    isPrimary: true,
  },
  {
    platformId: "amazon",
  ...
  },
  {
    ...
    stateCode: "09",
    stateName: "Uttar Pradesh",
    ecoGstin: "09AARCM9332R1CM",
    legalName: "Amazon Wholesale / Services",
    status: "VERIFIED",
    source: "Amazon MTR TCS",
    isPrimary: false,
  },
  {
    platformId: "amazon",
...
export const MEESHO_ECO_REGISTRY: EcoRegistryEntry[] = [
  ...
  },
  {
    ...
    stateCode: "09",
    stateName: "Uttar Pradesh",
    ecoGstin: "09AAICA3918J1CR",
    legalName: "Fashnear Technologies Pvt Ltd (Meesho)",
    status: "VERIFIED",
    source: "Meesho Supplier TCS",
    isPrimary: true,
  },
  {
    platformId: "meesho",
  ...
  },
  {
    ...
    stateCode: "36",
    stateName: "Telangana",
    ecoGstin: "36AACCF6368D1CY",
    legalName: "Meesho Limited (Active ECO)",
    status: "VERIFIED",
    source: "GST Registry",
    isPrimary: true,
  },
...
export const FLIPKART_ECO_REGISTRY: EcoRegistryEntry[] = [
  {
    ...
    stateCode: "03",
    stateName: "Punjab",
    ecoGstin: "03AABCF8078M1ZB",
    legalName: "Flipkart India Pvt Ltd",
    status: "VERIFIED",
    source: "Flipkart Hub Master",
    isPrimary: true,
  },
  {
    platformId: "flipkart",
...
export function resolveEcoGstin(options: ResolveEcoOptions): EcoResolutionResult {
  ...
  if (userFallbackGstin && isValidGstin(userFallbackGstin)) {
    return {
      ecoGstin: userFallbackGstin.trim().toUpperCase(),
  ...
  if (rowGstin && isValidGstin(rowGstin)) {
    return {
      ecoGstin: rowGstin.trim().toUpperCase(),
      ecoName: getPlatformName(normPlatform),
  ...
  if (normPlatform === "amazon") {
    fallbackGstin = `${supplierState}AAICA3918J1ZG`;
  } else if (normPlatform === "meesho") {
    fallbackGstin = `${supplierState}AAICA3918J1CR`;
  } else if (normPlatform === "flipkart") {
    fallbackGstin = `${supplierState}AABCF8078M1ZZ`;
  } else {
    fallbackGstin = `${supplierState}AAICA3918J1ZG`;
  }

  return {
    ecoGstin: fallbackGstin,
    ecoName: getPlatformName(normPlatform),
