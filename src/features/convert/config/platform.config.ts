    ...
    files: [
      {
        ...
        headerKeywords: ["invoice_number", "buyer_gstin", "taxable_value"],
      },
      {
        id: "b2c",
        ...
        required: false,
        fileTypes: [".xlsx", ".xls", ".csv"],
        headerKeywords: ["ship_to_state", "invoice_amount"],
      },
      {
        id: "credit_notes",
        ...
        required: false,
        fileTypes: [".xlsx", ".xls", ".csv"],
        headerKeywords: ["credit_note", "refund"],
      },
    ],
  },
  {
    ...
    files: [
      {
        ...
        required: true,
        fileTypes: [".xlsx", ".xls", ".csv"],
        headerKeywords: ["sub_order_no", "taxable_amount", "end_customer_state"],
      },
      {
        id: "returns",
        ...
        required: true,
        fileTypes: [".xlsx", ".xls", ".csv"],
        headerKeywords: ["return", "sub_order_no"],
      },
    ],
  },
  {
